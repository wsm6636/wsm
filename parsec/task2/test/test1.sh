...
#       ./test &
	...
	sudo ./b2/blackscholes2 1 ~/parsec-rt/blackscholes-rt/input/in_medium.txt ./out/out9.txt &
#       ./test &
        sudo ./dedup2/dedup-rt/dedup2 -c -p -v -t 1 -i ~/parsec-rt/dedup-rt/input/in_small.dat -o ./out/out10.dat.ddp &
